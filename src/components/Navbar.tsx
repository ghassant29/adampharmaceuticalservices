...
const Navbar = ({ onlyHome }: Props) => {
  ...
  return (
    <nav className="md:absolute md:top-0 md:left-0 flex justify-between px-8 md:px-0 md:justify-center items-center w-full mx-auto text-white bg-white-gradient">
      <div className="w-full block md:hidden">
        <img className="h-28 w-28" src="/images/logo_adam.png" />
      </div>
